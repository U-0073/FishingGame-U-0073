...
void CCamera::Set(const D3DXVECTOR2& mWindowSize)
{
	...
	KdMatrix mView, mProj;

	KdVec3 LookPos = Pos + LookVec;
	// 視点行列の設定
	D3DXMatrixLookAtLH(&mView,
		...
		&LookPos,
		&KdVec3(0.0f, 1.0f, 0.0f)	// カメラの頭の方向
	);
...
void CCamera::SetCameraPos(const KdVec3& _Pos, const KdVec3& _LookPos)
{
	Pos = _Pos;
...
void CCamera::SetCameraVec(const KdVec3& _Pos, const KdVec3& _LookVec)
{
	Pos = _Pos;
	LookVec = _LookVec;
}
